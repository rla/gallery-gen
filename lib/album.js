...
var create = exports.create = function(dir) {
    ...
    var album = {
        ...
        postprocess: function(target, title, url, breadcrumb) {
            ...
            if (album.info.order === 'year') {

                debug('Sorting ' + album.info.title + ' by year.');

                album.sorted.albums.sort(function(a1, a2) {

                    if (typeof a1.info.year === 'undefined') {

                        return 1;
                    }

                    if (typeof a2.info.year === 'undefined') {

                        return -1;
                    }

                    return a1.info.year === a2.info.year ? 0 : (a1.info.year > a2.info.year ? -1 : 1);
                });
            }
